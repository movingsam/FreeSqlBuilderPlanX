...
namespace FreeSqlBuilderPlanX.Infrastructure.Dependency.AutoFac
{
    public static class Ioc
    {
        ...
        public static IContainer CreateContainer(params IModule[] configs)
        {
            var container = new Container();
            container.Register(null, configs);
            return container;
        }
        ...
        /// </summary>
        /// <param name="configs">依赖配置</param>
        public static void Register(params IModule[] configs)
        {
        ...
        /// <param name="configs">依赖配置</param>
        public static IServiceProvider Register(IServiceCollection services, params IModule[] configs)
        {
            return DefaultContainer.Register(services, configs);
        }
